 ...
 * @date 2016/07/03
 */
public abstract class AbsHttpHandler<T> implements Callback {
    ...
    protected abstract void parseResult(String respBodyStr);
...
//    }
    ...
    protected final void onSuccessOnUIThread(final ServerTip serverTip, final T t) {
    ...
    protected final void onFailureOnUIThread(final ServerTip serverTip) {
        NetEaseApplication.runUiThread(new Runnable() {
            @Override
            public void run() {
