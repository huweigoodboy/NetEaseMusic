 ...
 * @date 2016/07/04
 */
public class SrMvListAdapter extends HeaderBottomAdapter<SrSongListResp, SrMvListAdapter.SrSongListViewHolder> {
    ...
    public SrSongListViewHolder onCreateContentViewHolder(ViewGroup parent, int viewType) {
        return new SrSongListViewHolder(mLayoutInflater.inflate(R.layout.item_sr_mv, null, true));
    }
