 ...
 * @date 2016/07/04
 */
public class SrPlayListAdapter extends HeaderBottomAdapter<SrSongListResp, SrPlayListAdapter.SrSongListViewHolder> {
    ...
    public SrSongListViewHolder onCreateContentViewHolder(ViewGroup parent, int viewType) {
        return new SrSongListViewHolder(mLayoutInflater.inflate(R.layout.item_sr_playlist, null, true));
    }
